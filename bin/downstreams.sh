...
usage() {
    ...
    echo "  -k    Set the module to run, should be one of: diffIns, diffComp, HaploCNV. Note: The diffComp module must be run first before proceeding with HaploCNV analysis."
