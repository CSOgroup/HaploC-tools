...
echo "RUNNING HapCUT22 ON EACH CHROMOSOME OF DUITAMA ET AL DATA"
mkdir data/hapcut2_haplotypes
# run HapCUT2 on each chromosome
for i in {1..22} X; do
    $HapCUT22 --fragments data/NA12878_fosmid_data_formatted/chr${i}.matrix.SORTED \
